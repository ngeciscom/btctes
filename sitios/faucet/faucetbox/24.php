...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 24/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/25.php");};
?>
...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 25/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/26.php");};
?>
...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 26/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/27.php");};
?>
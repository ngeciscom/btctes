...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 27/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/28.php");};
?>
...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 28/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/29.php");};
?>
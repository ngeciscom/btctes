...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 30/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/31.php");};
?>
...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 31/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/32.php");};
?>
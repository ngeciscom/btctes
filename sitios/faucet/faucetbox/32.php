...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 32/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/33.php");};
?>
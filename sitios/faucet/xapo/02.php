...
$ant_fau = "";
$ant_faucet = "01";
$fau_number = count(glob($_SERVER['DOCUMENT_ROOT']."/sitios/faucet/epay/{*.php}",GLOB_BRACE));
$lim = "9";
...
$siguiente_fau = "../xapo/03.php";
$total_xapo = count(glob("../xapo/{*.php}",GLOB_BRACE));
$next = "../xapo/03.php";
$siguiente_fau = "../xapo/03.php";
if (file_exists($siguiente_fau)) {$next = $next ;} else {$next = $url_base."sitios/faucet/faucetbox/01.php";};

if ($ant_faucet > "00") {
	$ant_faucet = $url_base."sitios/faucet/xapo/01";

} else {
	$ant_faucet =  $url_base."sitios/faucet/epay/".$fau_number;
};
...
<div class="loader">
  <div id="msj">Loading...</div>
     ...
     <!-- IFRAME DE LA FAUCET  -->
     <iframe src="'.$dir_web.'" name="faucet" border="0" width="100%" height="100%"></iframe>

<div id="botonera">
				<p> <font size="6px">'.$title.'</font> </p>
				<p> <font size="4px">'.$pago.'sat. / '.$tiempo.' min.</font> </p>
				<p> '.$s_pago.' - Faucet 02/'.$total_xapo.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/xapo/03.php");};
?>